...
LABELS = {
    "zh": {
        ...
        "target_name": "目标名称",
        "draft_path": "初稿路径",
        "materials_dir": "素材文件夹路径（用户材料，非“材料学”）",
        "user_motivation": "初始动机假设",
        "official_urls": "官方链接（作者指南等）",
        "reference_mode": "文献读取模式",
        "reference_paths": "本地参考文献路径",
        "citation_target_count": "最终引用目标数",
        "special_requirements": "特殊要求（如 Acta/PSP/Highlights）",
        "review": "检查配置",
        "confirm": "确认写入配置",
    ...
    "en": {
        ...
        "materials_dir": "Materials directory (user assets, not materials science)",
        "user_motivation": "Initial motivation hypothesis",
        "official_urls": "Official URLs (author guidelines, etc.)",
        "reference_mode": "Reference reading mode",
        "reference_paths": "Local reference paths",
        "citation_target_count": "Target citation count",
        "special_requirements": "Special requirements (e.g. Acta/PSP/Highlights)",
